"""The billing specialist's drafting chain (docs/PLAN.md Phase 3, D-A4-5)."""
...
def build_billing_specialist_chain(model: BaseChatModel) -> SpecialistChain:
    prompt = ChatPromptTemplate.from_messages(
        [
            ("system", load_prompt("billing_specialist_v1")),
            (
                "human",
                "Question: {question}\n\n"
